...
function onenter()
    ...
    ' Room A floor keeps the procedural checker; Room B floor cells carry
    ' ftex:rc_placeholder_tiles.png in lightpool.stm -- per-cell texturing.
    self.ren.setFieldTextures("", "")
