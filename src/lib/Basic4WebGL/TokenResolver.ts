...
export const tokenResolver: Array<TokenResolverRule> = [
  ...
  {
    isMatch: (input: string): TokenResolverRuleResult => ({
      ...matchPattern(input, /^endclass(?=[ \r\n]|[^a-zA-Z0-9]|$)/i),
      token: tokens.EndClass,
    }),
  },
  {
    isMatch: (input: string): TokenResolverRuleResult => ({
  ...
  {
    isMatch: (input: string): TokenResolverRuleResult => ({
      ...matchPattern(input, /^elseif(?=[ \r\n]|[^a-zA-Z0-9]|$)/i),
      token: tokens.ElseIf,
    }),
  },
  {
    isMatch: (input: string): TokenResolverRuleResult => ({
      ...matchPattern(input, /^else(?=[ \r\n]|[^a-zA-Z0-9]|$)/i),
      token: tokens.Else,
    }),
  },
  {
  ...
  {
    isMatch: (input: string): TokenResolverRuleResult => ({
      ...matchPattern(input, /^[A-Za-z_][A-Za-z_$0-9]*/),
