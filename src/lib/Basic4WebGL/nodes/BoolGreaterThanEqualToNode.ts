...
class BoolGreaterThanEqualToNode extends BaseNumericEqualityValidatorNode {
  constructor(left: Tree, right: Tree) {
    super(nodeTypes.GreaterThanEqualTo, undefined, [left, right]);
    this.dataType = getBuiltInType(builtInTypes.Boolean);
  }
}

export default BoolGreaterThanEqualToNode;
